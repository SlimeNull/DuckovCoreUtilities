...
namespace EleCho.JsonRpc.Utils
{
    internal static class RpcUtils
    {
        ...
        {
            Trace.WriteLine($"RPC ready to query method");
            ...
            try
            {
                Trace.WriteLine("RPC ready to execute method");
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                Trace.WriteLine("ReadPackageAsync: IOException, the connection may be closed.");
                return null;
            }
            finally
            {
